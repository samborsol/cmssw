...
struct MyRecHit{
  ...
  float EtTowerSumPlus;
  float EtTowerSumMinus;
  float EtTowerSum;
...
RecHitTreeProducer::analyze(const edm::Event& ev, const edm::EventSetup& iSetup)
{
  ...
  hfRecHit.EtTowerSum = 0.;
  hfRecHit.EtTowerSumPlus = 0.;
  hfRecHit.EtTowerSumMinus = 0.;
  hfRecHit.n = 0;
  hbheRecHit.n = 0;
  ebRecHit.n = 0;
  eeRecHit.n = 0;
  ...
  if(doHF_){
    ...
    hfRecHit.EtTowerSum = etHFtowerSum;
    hfRecHit.EtTowerSumPlus = etHFtowerSumPlus;
    hfRecHit.EtTowerSumMinus = etHFtowerSumMinus;
    cout<<"tower size = "<<towers->size()<<" ,  bin = "<<bin<<" ,  etHFtowerSum = "<<hfRecHit.EtTowerSum<<" ,  binLowEdge = "<<binLowEdge[bin]<<endl;
...
RecHitTreeProducer::beginJob()
{
  ...
  if(doHcal_){
    ...
    hfTree->Branch("totalEtHFplus",&hfRecHit.EtTowerSumPlus,"totalEtHFplus");
    hfTree->Branch("totalEtHFminus",&hfRecHit.EtTowerSumMinus,"totalEtHFminus");
    hfTree->Branch("totalEtHF",&hfRecHit.EtTowerSum,"totalEtHF");
  }
