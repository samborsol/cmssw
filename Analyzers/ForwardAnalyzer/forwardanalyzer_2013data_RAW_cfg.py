...
process.fwdana = cms.EDAnalyzer('ForwardAnalyzer_RAW',
                                l1GtRR=cms.InputTag("GtDigis")
                                )

#process.p = cms.Path(process.zdcreco*process.fwdana)
process.p = cms.Path(process.GtDigis*process.hltbitanalysis*process.hcalDigis*process.castorDigis*process.castorreco*process.hfreco*process.zdcreco*process.fwdana)
